// ============================================================
// 2048 – barevná paleta (src/theme.ts)
// ============================================================

// --- Základ ---
export const COLOR_BACKGROUND      = "#FAF8F0"; // krémová stránka
export const COLOR_GRID_BG         = "#BBADA0"; // pozadí mřížky
export const COLOR_CELL_EMPTY      = "#CDC1B4"; // prázdná buňka
export const COLOR_TEXT_DARK       = "#776E65"; // tmavý text (na světlých dlaždicích)
export const COLOR_TEXT_LIGHT      = "#F9F6F2"; // světlý text (na tmavých dlaždicích)

// --- Primární barva (UI prvky, tlačítka, nadpis) ---
export const COLOR_PRIMARY         = "#F5A623"; // oranžová – logo, CTA tlačítko
...
// --- Stavy ---
export const COLOR_SUCCESS         = "#4CAF50"; // nový rekord, výhra
...
export const TILE_COLORS: Record<number, { bg: string; text: string }> = {
  ...
  2048: { bg: "#F5A623", text: COLOR_TEXT_LIGHT }, // cílová dlaždice
};
...
export const GRID_PADDING = "8px";  // padding mřížky
